...
static const int8_t SYNTH_EXPECTED_LOGITS[SYNTH_NUM_VECTORS][5] = {
    {  -36,   54,  -27,  -43,  -11 },  /* seed 1 */
    {  -26,   37,    0,  -28,  -12 },  /* seed 2 */
    {  -23,   43,   -1,  -41,  -17 },  /* seed 3 */
    {  -28,   40,    3,  -28,  -20 }  /* seed 12345 */
};
...
static const int8_t PATTERN_EXPECTED_LOGITS[PATTERN_NUM_VECTORS][5] = {
    {    5,  -23,   -9,    5,  -20 },  /* HRAMP */
    {    8,  -15,   -1,   -5,  -35 },  /* VRAMP */
    {   96,  -87,  -49,  -55,  -61 }  /* CHECKER */
};

static const uint8_t PATTERN_EXPECTED_CLASS[PATTERN_NUM_VECTORS] = { 0, 0, 0 };
